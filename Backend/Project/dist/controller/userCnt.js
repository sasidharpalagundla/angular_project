...
const repository = __importStar(require("../repository/userRepo"));
let findAllUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let result = yield repository.findAllUser();
    try {
        res.json(result);
    }
    catch (ex) {
...
let storeUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let user = req.body;
    try {
        let result = yield repository.storeUser(user);
